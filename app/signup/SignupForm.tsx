...
export default function SignupForm() {
  ...
  if (success) {
    return (
      <div className="min-h-screen text-text-primary selection:bg-white selection:text-black antialiased font-sans flex flex-col items-center justify-center px-4 relative overflow-hidden page-hero-bg">
  ...
  return (
    <div className="min-h-screen text-text-primary selection:bg-white selection:text-black antialiased font-sans flex flex-col items-center justify-center px-4 relative overflow-hidden page-hero-bg">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] rounded-full blur-[140px] pointer-events-none z-0 select-none opacity-50" style={{ backgroundImage: 'radial-gradient(circle at center, var(--glow-1) 0%, var(--glow-3) 60%, transparent 70%)' }} />
